...
public sealed class 预后Gcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        return HealerUtils.LowPartyCount(55f) >= 3 ? HealerUtils.Pass("预后群抬") : HealerUtils.Fail("群体血量安全");
    }

    public PAction GetAction() => HealerUtils.Gcd(SgeAction.预后, ActionTargetType.Self);
}
