...
{
    public class WarriorRotationEventHandler : IRotationEventHandler
    {
        // 每帧都会执行一次下面的方法
        public void OnUpdate()
        {
            if (PromeSettings.Instance.GetQt(WARQt.突进无位移))
            {
        ...
        public void OnBattleEnded()
        {
            ...
            PromeSettings.Instance.SetQt(WARQt.突进无位移, false);
        }
