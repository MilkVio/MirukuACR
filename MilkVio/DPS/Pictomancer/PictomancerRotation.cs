...
public class PictomancerRotation : IRotation
{
    ...
    public PictomancerRotation()
    {
        ...
        HotkeyUI.AddHotkey(new ActionHotkey(new PAction(MageUniversalSkill.沉稳咏唱, ActionType.OffGcd, ActionTargetType.Self)));
        HotkeyUI.AddHotkey(new ActionHotkey(new PAction(MageUniversalSkill.混乱, ActionType.OffGcd, ActionTargetType.Target)));
