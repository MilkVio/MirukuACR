...
namespace MilkVio.DPS.Pictomancer.Opener
{
    ...
    /// 一个绝枪战士的简单起手示例。
    /// </summary>
    public class PCT_100_2G_U : IOpener
    {
        public string OpenerName => "绘灵法师100级2G团辅起手";
        ...
        public void InitializeCountdown(CountDownHandler countdownHandler)
        {
            ...
            var 动物构想 = new PAction(PCTSkill.动物构想, ActionType.OffGcd, ActionTargetType.Target);
            ...
            countdownHandler.AddAction(500, 动物构想);
        }
    }
}
