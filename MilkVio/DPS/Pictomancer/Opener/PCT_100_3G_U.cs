...
namespace MilkVio.DPS.Pictomancer.Opener
{
    ...
    /// 绘灵法师100级3G团辅起手
    /// </summary>
    public class PCT_100_3G_U : IOpener
    {
        public string OpenerName => "绘灵法师100级3G团辅起手";
        ...
        public List<PAction> InCombatSequence => new()
        {
            ...
            // 11G
            new PAction(PCTSkill.火炎之红1, ActionType.Gcd, ActionTargetType.Target)
            {
                RequiresVerification = true
            },
            ...
            // 12G
            new PAction(PCTSkill.兽爪彩绘, ActionType.Gcd, ActionTargetType.Self)
            {
                RequiresVerification = true
            },
            new PAction(PCTSkill.动物构想, ActionType.OffGcd, ActionTargetType.Target),
        ...
        public void InitializeCountdown(CountDownHandler countdownHandler)
        {
            ...
            var 武器构想 = new PAction(PCTSkill.武器构想, ActionType.OffGcd, ActionTargetType.Self);
            ...
            countdownHandler.AddAction(5000, 彩虹点滴);
            // countdownHandler.AddAction(500, 武器构想);
        }
    }
}
