...
public class 弹射OffGcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        if (MachinistHelper.Get弹射CurrentId().GetActionCharges() >= 1)
        {
    ...
    {
        return new PAction(MachinistHelper.Get弹射CurrentId(), ActionType.OffGcd, ActionTargetType.Target);
    }
}
