...
public class 整备掘地飞轮OffGcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        if (MCHSkill.整备.GetActionCharges() >= 1 && me.HasStatus(MCHStatus.掘地飞轮预备))
        {
