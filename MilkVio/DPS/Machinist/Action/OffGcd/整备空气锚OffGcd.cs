...
public class 整备空气锚OffGcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        if (me.Level < 76) return new CheckResult(false, "等级不足");
        ...
        if (MCHSkill.整备.GetActionCharges() >= 1 && MCHSkill.空气锚.GetActionCooldown() < 1)
        {
