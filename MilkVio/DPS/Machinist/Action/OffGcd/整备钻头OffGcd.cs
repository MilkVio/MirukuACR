...
public class 整备钻头OffGcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        if (MCHSkill.整备.GetActionCharges() >= 1 && MachinistHelper.GetCurrent钻头Charge() >= 0.95)
        {
