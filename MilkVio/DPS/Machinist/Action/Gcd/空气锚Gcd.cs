...
public class 空气锚Gcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        if (MachinistHelper.Get空气锚CurrentId().GetActionCooldown() < 1)
        {
    ...
    {
        return new PAction(MachinistHelper.Get空气锚CurrentId(), ActionType.Gcd, ActionTargetType.Target);
    }
}
