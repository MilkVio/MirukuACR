...
public class 灼热之闪OffGcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        if (SMNSkill.灼热之闪.GetActionCooldown() != 0) return new CheckResult(false, "未冷却");
        
        if (me.HasStatus(SMNBuff.灼热之闪预备) && me.HasStatus(SMNBuff.灼热之光)) return new CheckResult(true, "有Buff打一个");
    ...
    {
        return new PAction(SMNSkill.灼热之闪, ActionType.OffGcd, ActionTargetType.Target);
    }
}
