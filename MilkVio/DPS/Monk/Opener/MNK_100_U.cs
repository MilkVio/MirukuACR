...
public class MNK_100_U : IOpener
{
    public string OpenerName => "武僧100通用3G爆发起手";
    ...
    public List<PAction> InCombatSequence => new()
    {
        ...
        // 2G
        new PAction(MNKSkill.猿舞连击, ActionType.Gcd, ActionTargetType.Target)
        {
            RequiresVerification = true
        },
    ...
    public void InitializeCountdown(CountDownHandler countdownHandler)
    {
        ...
        countdownHandler.AddAction(300, 轻身);
    }
}
