...
public class DRG_90_U : IOpener
{
    public string OpenerName => "龙骑士90通用起手";
    ...
    public List<PAction> InCombatSequence => new()
    {
        ...
        // 2G
        new PAction(DRGSkill.开膛枪,ActionType.Gcd,ActionTargetType.Target)
        {
            RequiresVerification = true
        },
    ...
    {
        countdownHandler.AddAction(499, new PAction(DRGSkill.龙翼滑翔, ActionType.OffGcd, ActionTargetType.Target));
    }
}
