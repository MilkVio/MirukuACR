...
public class SAM_90_OMG : IOpener
{
    public string OpenerName => "武士绝欧起手";
    ...
    public List<PAction> InCombatSequence => new()
    {
        ...
        // 这里可以吃爆发药
        new PAction(SAMSkill.意气冲天, ActionType.OffGcd, ActionTargetType.Self),
        ...
        new PAction(SAMSkill.必杀剑_闪影, ActionType.OffGcd, ActionTargetType.Target),
