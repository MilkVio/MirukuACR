...
public class 劫火遁Gcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        if (hasShengsha && !PromeSettings.Instance.GetQt(NinjaQt.不打60) && TargetHelper.EnemyIn5m() >= 3)
        {
    ...
    {
        ActionQueueManager.Enqueue(NinjaHelper.NinjaNinjyutsu.火遁);
