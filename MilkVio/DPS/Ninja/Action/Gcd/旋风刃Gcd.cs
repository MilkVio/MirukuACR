...
public class 旋风刃Gcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        {
            if (NinjaHelper.GetNinjaPositionAction() == Positional.Rear)
            {
    ...
    {
        return new PAction(NinjaSkill.旋风刃, ActionType.Gcd, ActionTargetType.Target);
    }
}
