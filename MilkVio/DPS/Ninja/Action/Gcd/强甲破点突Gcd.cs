...
public class 强甲破点突Gcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        {
            if (NinjaHelper.GetNinjaPositionAction() == Positional.Flank)
            {
    ...
    {
        return new PAction(NinjaSkill.强甲破点突, ActionType.Gcd, ActionTargetType.Target);
    }
}
