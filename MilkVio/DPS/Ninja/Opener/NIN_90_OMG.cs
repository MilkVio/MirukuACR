...
public class NIN_90_OMG : IOpener
{
    public string OpenerName => "忍者90欧米茄2G爆发起手";
    ...
    public List<PAction> InCombatSequence => new()
    {
        ...
        new PAction(NinjaSkill.天之印, ActionType.Gcd, ActionTargetType.Self)
        {
            RequiresVerification = true
        },
        new PAction(NinjaSkill.地之印派生, ActionType.Gcd, ActionTargetType.Self)
        {
            RequiresVerification = true
        },
        new PAction(NinjaSkill.忍术, ActionType.Gcd, ActionTargetType.Target),
        ...
        // 4G
        new PAction(NinjaSkill.月影雷兽牙, ActionType.Gcd, ActionTargetType.Target)
        {
            RequiresVerification = true
        },
