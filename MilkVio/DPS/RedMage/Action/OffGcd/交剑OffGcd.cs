...
public class 交剑OffGcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        // 自身不可以的条件
        if (RDMSkill.交剑.GetActionCharges() >= 1) return new CheckResult(true, "打一个");
    ...
    {
        return new PAction(RDMSkill.交剑, ActionType.OffGcd, ActionTargetType.Target);
    }
}
