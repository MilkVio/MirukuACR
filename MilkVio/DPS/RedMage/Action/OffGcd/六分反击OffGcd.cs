...
public class 六分反击OffGcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        // 自身不可以的条件
        if (RDMSkill.六分反击.GetActionCooldown() <= 0.05f) return new CheckResult(true, "打一个");
    ...
    {
        return new PAction(RDMSkill.六分反击, ActionType.OffGcd, ActionTargetType.Target);
    }
}
