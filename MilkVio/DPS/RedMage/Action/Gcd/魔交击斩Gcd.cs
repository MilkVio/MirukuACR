...
public class 魔交击斩Gcd : IDecisionResolver
{
    public CheckResult Check()
    {
        ...
        if (RedMageHelper.GetNextManaActionPhase(false) == 2) return new CheckResult(true, "打2");
        return new CheckResult(false, "当前不满足任何条件");
    }

    public PAction GetAction()
    {
        return new PAction(RDMSkill.魔交击斩2, ActionType.Gcd, ActionTargetType.Target);
    }
}
